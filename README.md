...
Data for Life is about solving real social and administrative friction points with technology.  
...
- an **Issuer Portal** 🏫
- a **Government Management Portal** 🏛️
- a **Legacy Record Digitization Portal** 🗂️
- a **mock VNeID-inspired experience** 📱 for a more realistic demo environment

The repository currently contains the main HTML entry points for those flows, along with supporting assets, data files, a notebook, and a project PDF.
...
### 4. Government or regulator workflow ⚖️
